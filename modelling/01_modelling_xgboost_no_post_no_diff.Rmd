...
```{r}
results_dir = "D:/Results/xgb_model_no_post_no_diff/"
mkdirs(results_dir)
```
...
## Further exclude variables with post index and with diff
...
var2eliminate = union(var_post, var_diff)
