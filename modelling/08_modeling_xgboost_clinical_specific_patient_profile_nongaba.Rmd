...
```{r}
var2use = vector('list',3)
var2use[[1]] = config_$Column [ config_$v2] 
var2use[[1]] =  var2use[[1]] [ str_detect(var2use[[1]],'num') ]

var2use[[2]] = config_$Column [ config_$v2] 
var2use[[2]] =  var2use[[2]] [ str_detect(var2use[[2]],'diff') ]

var2use[[3]] = config_$Column [ config_$v2]
...
for (i in 1:3) {
  ...
  write_xgb_model(trained_model, results_dir = results_dir_, 
...
nbin = 20
table_ = tibble( prec[[1]]$rec_binned[1:nbin], prec[[1]]$prec[1:nbin], 
  prec[[2]]$prec[1:nbin], prec[[3]]$prec[1:nbin])
colnames(table_) = c('Recall bin', cname[1:3])
