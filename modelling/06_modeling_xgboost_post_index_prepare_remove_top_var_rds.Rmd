...
var2remove_manually_additional = #'post_lab_radio_date_fst_diff'   
  c('post_lab_radio_date_fst_diff','post_mgmt_date_fst_diff','post_other_outpat_date_fst_diff')
...
```{r}
fnames = vector('list',4)
for (i in 1:4) {
  fnames[[i]]  = paste0(
    'D:/Results/modelling_04_post_index_remove_top_var/xgb_complied_',
...
table_ = tibble( prec[[1]]$rec_binned[1:100], prec[[1]]$prec[1:100], 
  prec[[2]]$prec[1:100], prec[[3]]$prec[1:100], prec[[4]]$prec[1:100])
...
vi_fnames = vector('list',4)
for (i in 1:4) {
  vi_fnames[[i]]  = paste0(results_dir,
    'xgb_complied_',cname[i],
