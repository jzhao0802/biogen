...
```{r}
# what is this for?
results_dir = "F:/Projects/Biogen_Tecfidera/Results/modelling_08_copay_test/"
mkdirs(results_dir)
...
```{r}
# LM: These look cool but what are they for?
...
We want to remove variables which won't be used in any models
