...
```{r}
config_old = read_csv("D:/Results/var_config/combined_data_var_config.csv")
...
dict = read_csv('D:/Data/Flat_File_v5/profiling_variables.csv')
...
var_config_generator(
  input_csv = "D:/Data/Flat_File_v5/BGN_1158015_pat_data.csv",
...
config_p$Column = str_to_lower(config_p$Column)
...
```{r}
var_config_generator(
  input_csv = "D:/Data/Flat_File_v5/BGN_1158015_PHYS_DATA.csv",
...
```{r}
description_p = read_csv("D:/Data/Flat_File_v5/BGN_1158015_contents.csv")
...
description_d = read_csv("D:/Data/Flat_File_v5/BGN_1158015_contents_physician.csv")
