...
physician_ <- read_transform(
  input_csv = "D:/Data/Flat_File_v5/BGN_1158015_PHYS_DATA_unique_npi.csv",
  var_config_csv = "D:/Results/var_config/biogen_new_doctor_var_config.csv",
  read_key_as_double = FALSE
)

data_ <- read_transform(
  input_csv = "D:/Data/Flat_File_v5/BGN_1158015_pat_data_unique_pat_id.csv",
  var_config_csv = "D:/Results/var_config/biogen_new_patient_var_config.csv",
  read_key_as_double = FALSE
)

data_ <- read_transform(
  input_csv = "D:/Data/Flat_File_v5/BGN_1158015_pat_data_numeric_pat_id.csv",
  var_config_csv = "D:/Results/var_config/biogen_new_patient_var_config.csv",
  read_key_as_double = FALSE
)

#  There are 7851 entries but only 7748 unique values; 103 duplicate patients
```
...
data_doctor =  physician_$data %>% filter(npi %in% common.npi) %>% select (-one_of('pat_id'))
...
combined_config = rbind(config_p, config_d %>% filter( ! (Column=='npi')))
...
combined_config = config_with_colnames(colnames(combined_data), combined_config)
